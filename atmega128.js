...
function atmega128(uart0_cb, sleep_cb, bootsz, bootrst)
{
    ...
    var mega = Module.ccall('emsc_atmega128_init', 'number', ['number', 'number', 'number', 'number'], [emsc_uart0_cb, emsc_sleep_cb, bootsz, bootrst]);
